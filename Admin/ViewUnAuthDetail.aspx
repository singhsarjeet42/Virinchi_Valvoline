<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewUnAuthDetail.aspx.cs" Inherits="ViewUnAuthDetail" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							Duplicate Mechanic <small></small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="ViewUnAuthDetail.aspx">View Duplicate Mechanic</a></li>
						...
						<form id="Form1" runat="server" class="form-horizontal">
                                 ...
                                 <asp:ScriptManager ID="ScriptManager2" runat="server" 
                                  ...
                                  <div class="portlet box blue">
                                       <div class="portlet-title">
								                <div class="caption"><i class="icon-edit"></i>Duplicate Mechanic List</div>
								                      <div class="tools">
                                       ...
                                       <div class="portlet-body">
                                                ...
                                                <div class="span6 ">
														...
														<asp:Button ID="Button3" runat="server" Text="DownloadExcel"  class="btn green" 
									...
									<table class="center" id="sample_editable_1">
                                     <asp:GridView ID="DataGridview" runat="server" AutoGenerateColumns="False" DataKeyNames="id"
                                            onrowcommand="DataGridview_RowCommand"   
                                            CssClass="table table-striped table-hover table-bordered" AllowPaging="True" 
                                            onpageindexchanging="DataGridview_PageIndexChanging" CellPadding="5" >
                                    <Columns>
                                 ...
                                 <asp:templatefield HeaderText="Select">
                                  ...
                                  <%--<div class="form-actions">--%>
                                    <div align="Center">
                                        <asp:Button ID="btnDeleteRecord" runat="server" class="btn red" OnClick="btnDeleteRecord_Click" OnClientClick="return confirm('Are you sure you want to delete selected items?');" Text="Delete"/>
                                      </div>
                                  <%-- </div>--%>
                                 </div>
                              </ContentTemplate>
