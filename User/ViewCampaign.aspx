<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewCampaign.aspx.cs" Inherits="ViewCampaign" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">View Campaign <small></small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="ViewCampaign.aspx">View Campiagn</a></li>
                            ...
                            <div class="span12">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-edit"></i>Campaign List</div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            ...
                                            <div class="btn-group pull-right">
                                                <asp:Button ID="btnDownloadCampaign" Class="btn green" runat="server" Text="Download Campaign" OnClick="btnDownloadCampaign_Click" />
                                        ...
                                        <div runat="server" id="CampaignList">
                                        </div>
                                        <br />
        ...
        function Delete(id) {
            bootbox.confirm("Are you sure you want to delete this record?", function (result) {
                if (result) {
                    $.ajax({
                        type: "POST",
                        url: "ViewCampaign.aspx/Delete",
                        data: JSON.stringify({ Id: id }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (result) {
                            if (result.d == "HaveUser") {
                                bootbox.alert("Campaign cannot be deleted as user exists");
                            }
                            else {
