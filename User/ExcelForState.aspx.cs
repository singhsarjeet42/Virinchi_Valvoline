...
public partial class User_ExcelForState : System.Web.UI.Page
{
    ...
    public void SearchData()
    {
        ...
        if (IsStateAll != null)
        {
            #region Mechanic list for a state head is state is 'All'
            SqlCommand cmd = new SqlCommand("ExportExcelStateForAll", con);
        ...
        {
            #region Mechanic list base on state for a state head
            string StateName = "";
            ...
            SqlCommand cmd = new SqlCommand("ExportExcelState", con);
            cmd.CommandType = CommandType.StoredProcedure;
