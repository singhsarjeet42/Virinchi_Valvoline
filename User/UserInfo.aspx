						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<table style="width:500px; font-size:large;">
                                        <tr>
                                            <td>
                                                User Name
                                            </td>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="MobileNumber" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td id="ListOfSegment" runat="server">
                                         ...
                                         <tr>
                                            ...
                                            <td id="ListOfState" runat="server">
