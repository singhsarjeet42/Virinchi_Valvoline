<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MechanicListForDG.aspx.cs" Inherits="MechanicListForDG" EnableEventValidation="false" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">Mechanic List <small></small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="ValvolineData.aspx">Mechanic List</a></li>
                                    ...
                                    <div class="portlet box blue">
                                                ...
                                                <div class="span7">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls" align="right">
                                                            <asp:Button ID="Button1" runat="server" Text=" Search " class="btn green"
                                                                OnClick="BtnAddNew_Click" />

                                                        </div>
                                                    </div>
                                                    <br />
                                                    <asp:Label Style="font-size: 25px;" ID="Count" runat="server"></asp:Label>
                                                </div>
                                                <!--/span-->
                                       ...
                                       ControlStyle-Height = "100" HeaderText = "Preview Image"/>--%>
                                                                ...
                                                                <asp:TemplateField HeaderText="Created On">
                                                                    <ItemTemplate>
                                                                        <%#Eval("createdOn", "{0:ddd, MMM d, yyyy}")%>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
