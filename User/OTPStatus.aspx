<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OTPStatus.aspx.cs" Inherits="User_OTPStatus" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">OTP Status List<small></small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div runat="server" id="OTPStatusList">
                                                </div>
                                            </div>
                                        </div>
                            </ContentTemplate>
