            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title">View Team <small></small>
                        </h3>
                        <ul class="breadcrumb">
                            <li>
                                <i class="icon-home"></i>
                            ...
                            <li><a href="ViewTeam.aspx">View Team</a></li>
                            ...
                            <div class="span12">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-edit"></i>Team List</div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="btn-group">
                                                ...
                                                <asp:Button ID="AddNew" runat="server" Text="AddNew" class="btn green"
                                                    OnClick="AddNew_Click" />
                                                <i class="icon-plus"></i>

                                            </div>
                                            <div class="btn-group pull-right">
                                                <asp:Button ID="btnExlViewTeam" class="btn green" runat="server" Text="Download Team" OnClick="btnExlViewTeam_Click" />
        ...
        function Delete(id) {
            bootbox.confirm("Are you sure you want to delete this record?", function (result) {
                if (result) {
                    $.ajax({
                        type: "POST",
                        url: "ViewTeam.aspx/Delete",
                        data: JSON.stringify({ Id: id }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (result) {
                            if (result.d == "HaveCampaign") {
                                bootbox.alert("Team cannot be deleted as campaign exists");
                            }
                            else {
                                bootbox.alert("Team deleted successfully", function () {
                                });
