<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MechanicListNotTag.aspx.cs" Inherits="User_MechanicListNotTag" %>
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <table style="width: 500px;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList Style="margin-left: 20px;" ID="UserList" runat="server"></asp:DropDownList>
                                                        </td>
                                                        <td>
                                                            <input type="button" id="Transfer" style="margin-left: 60px;" value="Map User" />
                                                        </td>
                                                        <td>
                                                ...
                                                <br />
                                                <img style="margin-left: 470px;" src="../img/load.gif" width="40" id="Loader" runat="server" />
    ...
    <script>
        $(function () {
            ...
            $("#Transfer").click(function () {
                ...
                if (ToUser != null && ToUser != "" && ToUser != "0") {
                    if (CheckBox.Checked.length > 0) {
                        $("#Loader").show();
                        $.ajax({
                            type: "POST",
                            url: "MechanicListNotTag.aspx/TransferMechanicForSelected",
