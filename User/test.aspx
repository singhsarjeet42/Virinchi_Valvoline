...
<html>    
  <head> 
    ...
    <style>
      ...
      .cluster-1{
        background: url(../images/valvoline50x50.png) no-repeat;
        line-height:50px;
      	width: 50px;
      	height: 40px;
      }
      .cluster-2{
        background: url(../images/valvoline60x48.png) no-repeat;
        line-height:53px;
      	width: 60px;
      	height: 48px;
      }
      .cluster-3{
        background: url(../images/valvoline70x46.png) no-repeat;
        line-height:66px;
      	width: 70px;
      	height: 56px;
      }
