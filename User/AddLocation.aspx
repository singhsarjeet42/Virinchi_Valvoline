<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLocation.aspx.cs" Inherits="AddState" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
                            <asp:Label ID="Llocation" runat="server" Text="Add Location"></asp:Label><small></small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
							...
							<li><a href="AddLocation.aspx">Add Location</a></li>
					...
					<div class="span12">
						<div class="portlet box blue" id="form_wizard_1">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i> Add Location<span class="step-title"></span>
								</div>
										...
										<div class="tab-pane active" id="tab1">
												<h3 class="block">Provide Location  details</h3>
                                                 ...
                                                 <div class="control-group">
													...
													<div class="controls">
														<asp:TextBox ID="txtstate" runat="server"  class="span6 m-wrap"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                          ControlToValidate="txtstate" ErrorMessage="Provide  state name" 
                                                ...
                                                <div class="control-group">
													...
													<div class="controls">
														<asp:TextBox ID="txtCity" runat="server"  class="span6 m-wrap"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                                          ControlToValidate="txtCity" ErrorMessage="Provide  city name" 
                                                          ForeColor="Red" Display="Dynamic">
                                                         </asp:RequiredFieldValidator>
                                                ...
                                                <div class="control-group">
													...
													<div class="controls">
														<asp:TextBox ID="txtDistrict" runat="server"  class="span6 m-wrap"></asp:TextBox>
                                                    </div>
												</div>
                                                ...
                                                <div class="control-group">
													...
													<div class="controls">
														<asp:TextBox ID="txtPincide" runat="server"  class="span6 m-wrap"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                          ControlToValidate="txtPincide" ErrorMessage="Provide  pincode " 
                                                          ForeColor="Red" Display="Dynamic">
                                                         </asp:RequiredFieldValidator>
                                                    </div>
												</div>
